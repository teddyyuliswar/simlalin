...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	<td>ID Pasal</td>
        	<td>:</td>
        	<td><input type="text" name="id_pasal" maxlength="50" required="required" /></td>
        </tr>
    	<tr>
        	<td>Pasal yang Dilanggar</td>
        	<td>:</td>
        	<td><input type="text" name="psl_yangdilanggar" maxlength="50" required="required" /></td>
        </tr>
    	<tr>
        	<td>Besar Denda</td>
        	<td>:</td>
        	<td><input type="text" name="besar_denda" maxlength="50" required="required" /></td>
        </tr>
    	<tr>
